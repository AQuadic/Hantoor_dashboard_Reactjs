...
import { updateSocials, UpdateSocialsPayload } from '@/api/setting/social/editSocial';
                ...
                {SocialData.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <input
                                type="text"
                                value={socialValues[item.key as keyof typeof socialValues] || ""}
                                onChange={(e) => handleChange(item.key, e.target.value)}
                                className="focus:outline-none text-[#636270] text-sm py-1"
