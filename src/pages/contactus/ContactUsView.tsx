    ...
    return (
        <section className='py-10 bg-white h-screen'>
            ...
            <div className='px-8'>
                ...
                <p className='text-[#071739] text-[19px] font-normal mt-5'>ابراهيم محمود</p>
                <p className='text-[#606C7E] text-[15px] font-normal mt-3'>+966 123456 789</p>
            </div>
            <hr className='my-4'/>
            <div className='px-8'>
                <h2 className='text-[#2A32F8] text-[19px] font-bold'>الملاحظات</h2>
                <p className='text-[#071739] text-[19px] font-normal mt-5'>
