...
export const privateRoutes: RouteTypes[] = [
  ...
  // Models route (Car Sections)
  {
    ...
    element: <ModelPage />,
    requiredPermissions: [
      "view_vehicle_model", "create_vehicle_model", "edit_vehicle_model", "delete_vehicle_model",
      "view_vehicle_class", "create_vehicle_class", "edit_vehicle_class", "delete_vehicle_class",
      "view_vehicle_type", "create_vehicle_type", "edit_vehicle_type", "delete_vehicle_type",
      "view_category", "create_category", "edit_category", "delete_category",
      "view_brand_origin", "create_brand_origin", "edit_brand_origin", "delete_brand_origin",
      "view_seat_count", "create_seat_count", "edit_seat_count", "delete_seat_count",
      "view_engine_type", "create_engine_type", "edit_engine_type", "delete_engine_type",
      "view_engine_size", "create_engine_size", "edit_engine_size", "delete_engine_size",
      "view_price_from", "create_price_from", "edit_price_from", "delete_price_from",
      "view_price_to", "create_price_to", "edit_price_to", "delete_price_to",
    ],
    requireAny: true,
  },
  {
