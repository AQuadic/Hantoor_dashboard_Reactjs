        ...
        <section>
            ...
            <div className="w-full bg-white mt-3 rounded-[15px] py-[19px] px-[29px]">
                ...
                <div className="relative">
                    ...
                    />
                    <h2 className="text-[#000000] text-[15px] font-normal absolute top-5 right-4">الاسم</h2>
                ...
                <div className="flex md:flex-row flex-col items-center gap-[15px]">
                    ...
                    <div className="relative w-full">
                        <input 
                            ...
                            placeholder="username@mail.com"
                        />
                        <h2 className="text-[#000000] text-[15px] font-normal absolute top-5 right-4">البريد الالكنتروني</h2>
                        <div className="absolute top-9 left-5">
                    ...
                    <div className="relative w-full">
                        <input 
                            ...
                            placeholder="+20"
                        />
                        <h2 className="text-[#000000] text-[15px] font-normal absolute top-5 right-4">رقم الجوال</h2>
                        <div className="absolute top-9 left-5">
                ...
                <div className="flex md:flex-row flex-col items-center gap-[15px] mt-4">
                    ...
                    <div className="w-full">
                        <Select>
                        <SelectTrigger className="w-full !h-[53px] rounded-[12px] mt-4" dir="rtl">
                    ...
                    <div className="relative w-full">
                        ...
                        placeholder="********************"
                        />
                        <h2 className="text-[#000000] text-[15px] absolute top-5 right-4">كلمة المرور</h2>
